...
**Eyeball collects nothing, stores nothing about you, and sends nothing
anywhere.**

- **No data collection.** Eyeball does not collect, store, or transmit any
...
Eyeball reads only the cursor's `clientX` / `clientY` coordinates from
...
https://github.com/kkomelin/eyeball/issues
